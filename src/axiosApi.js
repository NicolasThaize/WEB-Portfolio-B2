...
const axiosInstance = axios.create({
    ...
    timeout: 5000,
    headers: {
        'Authorization': localStorage.getItem('nthaize_access_token') ? "JWT " + localStorage.getItem('nthaize_access_token') : null,
                ...
                if (tokenParts.exp > now) {
                    return axiosInstance
                        ...
                        .then((response) => {
                            ...
                            localStorage.setItem('nthaize_access_token', response.data.access);
                            localStorage.setItem('nthaize_refresh_token', response.data.refresh);
